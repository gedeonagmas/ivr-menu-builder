...
import { finishOnKeyOptions, VoicemailRecordingNodeSchema } from './schema';
import { getScope } from '@/features/json-form/utils/get-scope';

const scope = getScope<VoicemailRecordingNodeSchema>;
      ...
      elements: [
        {
          ...
          elements: [
            { type: 'Label', text: 'Max Duration (seconds):' },
            { type: 'Number', scope: scope('properties.maxDuration') },
          ],
        },
        {
          type: 'HorizontalLayout',
        ...
        },
        {
          type: 'HorizontalLayout',
          elements: [
            { type: 'Label', text: 'Play Beep:' },
            { type: 'Switch', scope: scope('properties.playBeep') },
          ],
        },
      ],
    },
