...
import { ivrCallFlow } from './templates/ivr-call-flow';
...
export const templates: TemplateModel[] = [ivrCallFlow, simpleFlow, userRegistration, blackFriday, callFlow].map(snapTemplateToGrid);
